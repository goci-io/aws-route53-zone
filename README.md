...
To configure this Module creating Nameserver Records in a Parent Domain within a different Account you can configure the AWS Providers like this:
...
module "zone" {
  ...
  providers = {
    # aws      = aws.current If you are running in a completely different Account
